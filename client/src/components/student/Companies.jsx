...
const Companies = () => {
  return (
    <div className="pt-10 sm:pt-16 w-full">
      <p className="text-sm sm:text-base text-gray-500">Trusted by learners from</p>
      <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 md:gap-16 md:mt-10 mt-5">
