        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 py-12 border-b border-white/20">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-300">
              Your trusted learning management platform. Access courses, track progress, and achieve your educational goals.
            </p>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-300">Get the latest updates, news and course information directly to your inbox</p>
            <form className="mt-2 flex flex-col sm:flex-row gap-2">
              <input 
                type="email" 
                placeholder="Enter your email" 
                className="bg-gray-800 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm flex-grow"
                required
              />
              <button 
                type="submit" 
                className="bg-blue-600 hover:bg-blue-700 text-white rounded px-4 py-2 text-sm transition-colors font-medium"
              >
                Subscribe
              </button>
            </form>
